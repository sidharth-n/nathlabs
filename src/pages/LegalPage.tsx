...
const policies: Record<string, Policy> = {
  '/privacy': {
    ...
    intro: 'This policy explains how Natha Labs handles personal information when you visit our website, contact us or buy our services.',
    sections: [
      {
      ...
      { title: 'Contact', paragraphs: ['For privacy questions or requests, email contact@nathalabs.com.'] },
    ],
  },
  '/terms': {
    title: 'Terms of Service',
    intro: 'These terms govern use of the Natha Labs website and services. A signed proposal, statement of work or product-specific agreement may add to or replace parts of these terms.',
    sections: [
      {
        title: 'Services',
        paragraphs: [
  ...
  '/refunds': {
    ...
    intro: 'We want payment terms to be clear before work starts. Project-specific terms in an accepted proposal or order form take priority over this general policy.',
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: ['Natha Labs currently provides digital services and software. We do not ship physical goods, so no physical return process applies.'],
      },
    ],
  },
  '/delivery': {
    title: 'Service Delivery Policy',
    intro: 'Natha Labs delivers software and professional services digitally. The exact delivery plan is agreed with each customer before payment.',
    sections: [
      {
      ...
      {
        title: 'Support',
        paragraphs: ['For delivery questions, email contact@nathalabs.com or call +971 52 262 8164.'],
      },
    ],
  },
};
...
export default function LegalPage({ path }: LegalPageProps) {
  ...
  useEffect(() => {
    document.title = `${policy.title} | Natha Labs`;
    document
      ...
      <div className="container legal-layout">
        ...
        <div className="legal-content">
          ...
          <section className="legal-company">
            ...
            <p><strong>Legal name:</strong> natha lab For Information Technology Consultants L.L.C S.O.C.</p>
            <p><strong>Commercial licence:</strong> 1529656</p>
            <p><strong>Registered location:</strong> Office 06, T-SH-D-16, Dubai Industrial City, Saih Shuaib 3, Dubai, United Arab Emirates</p>
            <p><strong>Email:</strong> <a href="mailto:contact@nathalabs.com">contact@nathalabs.com</a></p>
            <p><strong>Phone:</strong> <a href="tel:+971522628164">+971 52 262 8164</a></p>
          </section>
        </div>
      </div>
    </article>
