  ...
  const schema = [
    {
      ...
      url: `https://www.nathalabs.com/${page.slug}`,
      areaServed: { "@type": "Country", name: "United Arab Emirates" },
      provider: { "@id": "https://www.nathalabs.com/#organization" },
    },
    {
      "@context": "https://schema.org",
      "@type": "BreadcrumbList",
      itemListElement: [
        {
          ...
          position: 1,
          name: "Home",
          item: "https://www.nathalabs.com/",
        },
        {
          "@type": "ListItem",
          position: 2,
          name: page.shortName,
          item: `https://www.nathalabs.com/${page.slug}`,
        },
      ],
    },
  ];
